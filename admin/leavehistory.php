                ...
                <div class="card">
                    <div class="card-content">
                        ...
                        <table id="example" class="display responsive-table ">
                            ...
                            $sql   = "SELECT admin.UserName, tblleaves.id, LeaveType,ToDate,FromDate,Description,PostingDate,AdminRemarkDate,AdminRemark,Status from tblleaves 
                            LEFT JOIN admin on (admin.id = tblleaves.adminid) 
                            where adminEmpid=:eid";
                            $query = $dbh->prepare($sql);
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <?php if ($result->Status == 0) : ?>
                                                <a href="edit-leave.php?id=<?= $result->id ?>">Edit</a>
                                                <a href="leavehistory.php?del=<?php echo htmlentities($result->id); ?>">Delete</a>
                                            <?php endif; ?>
                                        </td>
