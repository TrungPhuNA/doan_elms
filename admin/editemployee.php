...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['update'])) {
        ...
        $sql = "update tblemployees set FirstName=:fname,LastName=:lname,SortName=:fullname, Gender=:gender,Dob=:dob,Department=:department,Address=:address,City=:city,Country=:country,Phonenumber=:mobileno, SomeHolidays=:some_holidays";
        if ($sql)
            $sql .= ", avatar=:avatar";
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col m6">
                                                <div class="row">
                                                    ...
                                                    <div class="input-field col s12">
                                                        <label for="phone">Some holidays</label>
                                                        <input id="some_holidays" name="some_holidays" type="number"
                                                               value="<?php echo htmlentities($result->SomeHolidays); ?>"
                                                               maxlength="10" autocomplete="off" required>
                                                    </div>
                                                    <div class="input-field col s12">
                                                    ...
                                                    <img src="/public/uploads/<?= $result->avatar ?>"
