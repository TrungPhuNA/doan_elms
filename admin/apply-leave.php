...
if (strlen($_SESSION['adminID']) == 0) {
    ...
    if (isset($_POST['apply'])) {
        $adminEmpid     = (int)$_SESSION['adminID'];
        ...
        $sql   = "INSERT INTO tblleaves(LeaveType,ToDate,FromDate,Description,Status,IsRead,empid,adminEmpid) VALUES(:leavetype,:fromdate,:todate,:description,:status,:isread,:empid,:adminEmpid)";
...
//        $query->bindParam(':adminID', $adminID, PDO::PARAM_STR);
        ...
        $query->bindParam(':adminEmpid', $adminEmpid, PDO::PARAM_STR);
