                ...
                <div class="card">
                    <div class="card-content">
                        ...
                        <table id="example" class="display responsive-table ">
                            ...
                            <tbody>
                            <?php $sql = "SELECT EmpId,FirstName,LastName,Department,Status,RegDate,id, avatar from  tblemployees";
                            $query     = $dbh->prepare($sql);
                            $query->execute();
                            ...
                            if ($query->rowCount() > 0) {
                                foreach ($results as $result) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <img src="/public/uploads/<?= $result->avatar ?>"  style="width: 80px;height: 80px;border-radius: 50%;display: inline-block" alt="">
                                        </td>
                                        ...
                                        <td class="text-center"><a href="editemployee.php?empid=<?php echo htmlentities($result->id); ?>"><i
