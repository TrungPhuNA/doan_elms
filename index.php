...
if (isset($_POST['signin'])) {
    ...
    if ($query->rowCount() > 0) {
        foreach ($results as $result) {
            ...
            $_SESSION['e_name'] = $result->SortName;
            $_SESSION['a_avatar'] = $result->avatar ?  $result->avatar : $avatar;
        }
        if ($status == 0) {
    ...
    <header class="mn-header navbar-fixed">
        <nav class="cyan darken-1">
            <div class="nav-wrapper row">
                <span style="position: absolute;   left: 50%;    transform: translateX(-50%);font-size: 44px">GDS</span>
    ...
    <aside id="slide-out" class="side-nav white fixed">
        <div class="side-nav-wrapper">
            ...
            <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion" style="">
                <li>&nbsp;</li>
                <li class="no-padding"><a class="waves-effect waves-grey" href="index.php"><i class="material-icons">account_box</i>Employe
                        Login</a></li>
                ...
                <li class="no-padding"><a class="waves-effect waves-grey" href="admin/"><i class="material-icons">account_box</i>Admin
                        Login</a></li>
                ...
                <div class="col s12 m6 l8 offset-l2 offset-m3">
                    <div class="card white darken-1">
                        ...
                        <div class="card-content ">
                            ...
                            <?php if ($msg) { ?>
                                <div class="errorWrap"><strong>Error</strong> : <?php echo htmlentities($msg); ?>
                                </div><?php } ?>
                            <div class="row">
