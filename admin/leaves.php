                ...
                <div class="card">
                    <div class="card-content">
                        ...
                        <form action="" class="form-inline">
                            <div class="row">
                                <div class="col s2">
                                    <input type="text" name="sortname" value="<?= $_GET['sortname'] ?>"
                                           class="form-control" placeholder="Full Name">
                                </div>
                                <div class="col s3">
                                    <button class="waves-effect waves-light btn blue m-b-xs">Search</button>
                                </div>
                            </div>
                        </form>
                        <?php if ($msg) { ?>
                        ...
                        <table id="example" class="display responsive-table ">
                            ...
                            if ($fullname)
                                $query->bindValue('sortname', '%' . $fullname . '%');
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="editemployee.php?empid=<?php echo htmlentities($result->id); ?>"
                                               target="_blank"><?php echo htmlentities($result->SortName); ?>
